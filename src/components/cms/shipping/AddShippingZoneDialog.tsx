...
const AddShippingZoneDialog = ({ children }: AddShippingZoneDialogProps) => {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new shipping zone to define regions and shipping methods.
          </DialogDescription>
        </DialogHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g., Cairo & Giza" {...field} />
                  </FormControl>
                  <FormDescription>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <FormDescription>
                      Enable this shipping zone immediately
                    </FormDescription>
                  </div>
                </FormItem>
              )}
...
export default AddShippingZoneDialog;
